...
<tr><td class="lefttd" align="center"> Name:</td><td><input type="text" name="t1" required="required" minlength="5" maxlength="10" title="please enter only character  between 5 to 15 for donor name" /></td></tr>
 <tr><td>&nbsp;</td></tr>
...
if(isset($_POST["sbmt"])) 
{
	...
	$cn=makeconnection();
		$d=$_POST["year"]."/".$_POST["month"]."/".$_POST["day"];
                $nm = mysqli_real_escape_string($cn, $_POST["t1"]);
			$s="insert into requestes(name,gender,age,mobile,bgroup,email,reqdate,detail) values('" . $nm ."','" . $_POST["r1"] . "','" . $_POST["t2"] . "','" . $_POST["t3"] . "','" . $_POST["t4"] . "','" . $_POST["t5"] . "','" . $d .  "','" .  $_POST["t7"]  ."')";
