...
<div style="height:300px; width:800px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:#f8f1e4; border:2px solid red; box-shadow:4px 1px 20px black;">
  ...
  <table cellspacing="0" cellpadding="0" width="800px" style="margin:auto" class="tableborder" >
        ...
        <tr><td colspan="4">&nbsp;</td></tr>
           ...
           <td>Camp Name</td><td>Date of Donation</td><td>No. of Units</td><td>Email Id</td><td>Details</td>
        </tr>
          <tr><td colspan="4">&nbsp;</td></tr>
    <?php

	
$cn=mysqli_connect("db","user","test","myDb");
$s="select * from camp,donation where camp.camp_id=donation.camp_id and donation.email='" . $_SESSION["email"] . "'";
	...
	{
				echo"<tr><td  style=' padding-left:50px'>$data[1]</td><td  style=' padding-left:50px'>$data[9]</td><td  style=' padding-left:40px'>$data[10]</td><td  style=' padding-left:30px'>$data[12]</td><td  style=' padding-left:30px'>$data[11]</td></tr>";
			}
			mysqli_close($cn);
			?>               
